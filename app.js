...
function enviarWhatsapp() {
    ...
    filas.forEach(fila => {
        ...
        pedidos += `*${titulo}* - ${precio}\n`;
    });

    const numeroTelefono = '921674886'; // Reemplaza con el número de teléfono al que quieres enviar los pedidos
    const mensaje = `Hola, estos son mis pedidos:\n\n${pedidos}`;
